...
Os códigos acima não estão funcionando na versão R mais recente. O motivo é explicado abaixo:
...
Os códigos acima só serão executados se o *CLD* funcionar na sua versão R.
