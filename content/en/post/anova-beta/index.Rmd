...
This post is also published on the [Open Weed Science](https://www.openweedsci.org/post/2019/12/20/one-way-anova-for-percentage-weed-control-data/) website.
...
The codes above is not working in the latest R version. The reason is explained below:
...
The codes above would only run if the *CLD* works in your R version.
