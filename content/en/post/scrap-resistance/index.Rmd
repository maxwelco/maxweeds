...
featured: no
image:
  caption: 'Image credit: [**Jo Jo**](https://unsplash.com/photos/r4L98e_1deI)'
  focal_point: ''
  preview_only: no
...
summary: 'Are you working on a presentation, grant proposal or a new manuscript? It’s likely your INTRO rests on the shoulders of Dr. Heap and his colleagues. Here’s our new post helping you optimize the process and get the herbicide resistance data you need.'
tags:
- herbicide
- resistance
- data manipulation
...
This post is originally from [Open Weed Science](https://www.openweedsci.org/post/2021/03/05/web-scraping-herbicide-weed-resistance-data/)
...
<iframe src="final_resistance_data.html" width="100%" height="500"></iframe>
